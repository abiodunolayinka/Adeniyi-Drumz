...
const Media = () => {
  return (
    <section id="media" className="py-24 bg-[#0F172A]">
      <div className="container">
        <div className="text-center mb-16 animate-fade-in">
          <span className="text-[#3B82F6] text-sm font-[600] uppercase tracking-widest">Press & Insights</span>
          ...
          <p className="text-[#94A3B8] mt-3 max-w-xl mx-auto text-base font-light">
            Featured in Nigerian press and sharing thoughts on engineering, AI, and building at scale.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {mediaFeatures.map((item, index) => {
            const isPress = item.source === "Vanguard" || item.source === "ThisDay Live";
            ...
            return (
              ...
              >
                <div className="relative overflow-hidden h-44">
                  ...
                  <span className={`absolute bottom-3 left-3 px-2.5 py-1 rounded-full text-xs font-[600] ${badgeClass}`}>
                    {item.source}
                  </span>
                </div>
