...
const mediaItems = [
  {
    id: 1,
    image: "/lovable-uploads/image1.jpg",
  ...
  {
    id: 2,
    image: "/lovable-uploads/image3.jpg",
    title: "Nigeria Tribune Newspaper Feature",
    description: "Nigerian-born Adeniyi Drumz hosts drum dialogue, rhythm exchange in Sheffield, UK ...",
  ...
  },
  {
    ...
    description: "Adeniyi Drumz: The Nigerian-born Drummer Making waves in the UK entertainment scene ...",
  ...
  },
  {
    ...
    description: "Adeniyi Drumz Set to Captivate Sheffield with Drums Dialogue & Rhythm Exchange...",
    ...
    <section id="blog" className="py-24 bg-white">
      <div className="container">
        <div className="text-center mb-12 animate-fade-in">
          <h3 className="text-sm uppercase text-drum-gold font-medium mb-2">Blog</h3>
